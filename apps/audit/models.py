...
class AIRun(models.Model):
    ...
    class Meta:
        # Supports the rolling-window COUNT the AI rate limiter runs on
        # every AI POST (apps/ai_core/rate_limit.py), and the newest-first
        # ordering the audit page already reads.
        indexes = [models.Index(fields=["-created_at"], name="airun_created_at_desc_idx")]
